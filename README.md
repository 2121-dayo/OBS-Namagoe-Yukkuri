...
## ◆DL方法◆
このページhttps://github.com/2121-dayo/OBS-Namagoe-Yukkuri.git右上側にある、緑色のCodeボタンを押して、Download.zipから.zipファイル形式で全体をDL。後は〔OBS生声ゆっくり〕フォルダごと好きなところに移動させてOKだと思います。README.mdファイルは要らないです。
